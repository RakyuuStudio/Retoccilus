// =========== Quaternion.inl ========== Re-Implementation of Assimp Quaternion ========= *- C++ -*
...
namespace Retoccilus::Engine3D::ModelImporter {
    ...
    RtMIQuaternion_Template<Tp>::RtMIQuaternion_Template(Tp pw, Tp px, Tp py, Tp pz)
        : w(pw),
          x(px),
          y(py),
          z(pz) {
    ...
    template <typename Tp>
    RtMIQuaternion_Template<Tp>::RtMIQuaternion_Template() noexcept : w(1.0),
                                                                      x(),
                                                                      y(),
                                                                      z() {
    }
    ...
    template <typename Tp>
    bool RtMIQuaternion_Template<Tp>::operator==(const RtMIQuaternion_Template &o) const {
    ...
    template <typename Tp>
    inline RtMIQuaternion_Template<Tp> &
    RtMIQuaternion_Template<Tp>::operator*=(const RtMIMatrix4x4_Template<Tp> &mat) {
        return (*this = mat * (*this));
    }

    template <typename Tp>
    inline bool RtMIQuaternion_Template<Tp>::equal(const RtMIQuaternion_Template &o,
                                                   Tp epsilon) const {
    ...
    template <typename Tp>
    inline RtMIQuaternion_Template<Tp>::RtMIQuaternion_Template(
        const RtMIMatrix3x3_Template<Tp> &pRotMatrix) {
        ...
        if (t > static_cast<Tp>(0)) {
            ...
            // Column 0:
            Tp s = std::sqrt(static_cast<Tp>(1.0) + pRotMatrix.a1 - pRotMatrix.b2 - pRotMatrix.c3) *
                   static_cast<Tp>(2.0);
            ...
            Tp s = std::sqrt(static_cast<Tp>(1.0) + pRotMatrix.b2 - pRotMatrix.a1 - pRotMatrix.c3) *
                   static_cast<Tp>(2.0);
            ...
            Tp s = std::sqrt(static_cast<Tp>(1.0) + pRotMatrix.c3 - pRotMatrix.a1 - pRotMatrix.b2) *
                   static_cast<Tp>(2.0);
    ...
    template <typename Tp>
    inline RtMIQuaternion_Template<Tp>::RtMIQuaternion_Template(Tp fPitch, Tp fYaw, Tp fRoll) {
    ...
    template <typename Tp>
    inline RtMIMatrix3x3_Template<Tp> RtMIQuaternion_Template<Tp>::getMatrix() const {
    ...
    template <typename Tp>
    inline RtMIQuaternion_Template<Tp>::RtMIQuaternion_Template(RtMIVector3D_Template<Tp> axis,
                                                                Tp angle) {
        axis.Normalize();
    ...
    template <typename Tp>
    inline RtMIQuaternion_Template<Tp>::RtMIQuaternion_Template(
        RtMIVector3D_Template<Tp> normalized) {
        x = normalized.x;
        y = normalized.y;
        z = normalized.z;
    ...
    inline void RtMIQuaternion_Template<Tp>::interpolate(RtMIQuaternion_Template &pOut,
                                                         ...
                                                         const RtMIQuaternion_Template &pEnd,
                                                         Tp pFactor) {
    ...
    template <typename Tp>
    inline RtMIQuaternion_Template<Tp> &RtMIQuaternion_Template<Tp>::normalize() {
    ...
    template <typename Tp>
    inline RtMIQuaternion_Template<Tp>
    RtMIQuaternion_Template<Tp>::operator*(const RtMIQuaternion_Template &t) const {
        return RtMIQuaternion_Template(
            w * t.w - x * t.x - y * t.y - z * t.z, w * t.x + x * t.w + y * t.z - z * t.y,
            w * t.y + y * t.w + z * t.x - x * t.z, w * t.z + z * t.w + x * t.y - y * t.x);
    }

    template <typename Tp>
    inline RtMIQuaternion_Template<Tp> &RtMIQuaternion_Template<Tp>::conjugate() {
        x = -x;
        y = -y;
        z = -z;
        return *this;
    ...
    RtMIQuaternion_Template<Tp>::rotate(const RtMIVector3D_Template<Tp> &v) const {
