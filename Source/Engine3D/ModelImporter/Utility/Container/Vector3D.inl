...
namespace Retoccilus::Engine3D::ModelImporter {
    template <typename Tp> RtMIVector3D_Template<Tp>::RtMIVector3D_Template(Tp _xyz) : x(_xyz), y(_xyz), z(_xyz) {}

    template <typename Tp>
    RtMIVector3D_Template<Tp>::RtMIVector3D_Template(Tp _x, Tp _y, Tp _z) : x(_x), y(_y), z(_z) {}

    template <typename Tp> RtMIVector3D_Template<Tp>::RtMIVector3D_Template() noexcept : x(), y(), z() {}
    ...
    RtMIVector3D_Template<Tp>::operator RtMIVector3D_Template<TOther>() const {
        return RtMIVector3D_Template<TOther>(static_cast<TOther>(x), static_cast<TOther>(y), static_cast<TOther>(z));
    }
    ...
    template <typename Tp> inline Tp RtMIVector3D_Template<Tp>::squareLength() const { return x * x + y * y + z * z; }
    ...
    template <typename Tp> inline RtMIVector3D_Template<Tp> &RtMIVector3D_Template<Tp>::normalizeSafe() {
        Tp len = this->length();
    ...
    template <typename Tp>
    inline const RtMIVector3D_Template<Tp> &RtMIVector3D_Template<Tp>::operator+=(const RtMIVector3D_Template<Tp> &o) {
        x += o.x;
        y += o.y;
        z += o.z;
    ...
    template <typename Tp> inline const RtMIVector3D_Template<Tp> &RtMIVector3D_Template<Tp>::operator*=(Tp f) {
        x *= f;
        y *= f;
        z *= f;
    ...
    template <typename Tp>
    inline RtMIVector3D_Template<Tp> &RtMIVector3D_Template<Tp>::operator*=(const RtMIMatrix3x3_Template<Tp> &mat) {
        return (*this = mat * (*this));
    }

    template <typename Tp>
    inline RtMIVector3D_Template<Tp> &RtMIVector3D_Template<Tp>::operator*=(const RtMIMatrix4x4_Template<Tp> &mat) {
        return (*this = mat * (*this));
    }
    ...
    template <typename Tp>
    inline bool RtMIVector3D_Template<Tp>::equal(const RtMIVector3D_Template<Tp> &other, Tp epsilon) const {
    ...
    template <typename Tp> inline RtMIVector3D_Template<Tp> operator*(Tp f, const RtMIVector3D_Template<Tp> &v) {
        return RtMIVector3D_Template<Tp>(f * v.x, f * v.y, f * v.z);
    }

    template <typename Tp> inline RtMIVector3D_Template<Tp> operator*(const RtMIVector3D_Template<Tp> &v, Tp f) {
        return RtMIVector3D_Template<Tp>(f * v.x, f * v.y, f * v.z);
    }
    ...
    template <typename Tp> inline RtMIVector3D_Template<Tp> operator-(const RtMIVector3D_Template<Tp> &v) {
