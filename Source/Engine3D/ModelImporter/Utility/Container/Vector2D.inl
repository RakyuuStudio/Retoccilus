...
namespace Retoccilus::Engine3D::ModelImporter {
    ...
    template <typename Tp> inline Tp RtMIVector2D_Template<Tp>::operator[](unsigned int i) const {
        if (i == 0) {
            return x;
        } else if (i == 1) {
            return y;
    ...
    RtMIVector2D_Template<Tp>::symmetricMultiply(const RtMIVector2D_Template<Tp> &o) {
